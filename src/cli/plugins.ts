...
const lookupPlugin = (name: string): Plugin | null => {
  ...
  if (typeof plugin.host !== "function" || typeof plugin.webview !== "function") {
    return null;
  }
  return plugin;
};
...
export const loadHostPlugins = (names: readonly string[] | undefined, runtime: Runtime): void => {
...
export const writeWebviewBundle = async (
  ...
  if (html.includes("butter-plugins.js")) {
    return true;
  }
