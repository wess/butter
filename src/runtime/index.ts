...
export const createRuntime = (initialWindow?: Partial<WindowOptions>): Runtime => {
...
export const sendChunk = (requestId: string, data: unknown) =>
  getRuntime().sendChunk(requestId, data);
...
export const setAlwaysOnTop = (enable: boolean) =>
  getRuntime().tell("window:alwaysontop", { enable });
